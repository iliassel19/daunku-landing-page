...
const Footer = () => {
  return (
    <div className="mt-28 pt-28 pb-12 bg-gradient-to-br from-lightDarkBlue to-veryDarkBlue slg:px-6">
      <Container className="pb-12 mb-8 border-b border-white flex items-start gap-16 slg:flex-col">
        ...
        <div className="flex-1 grid grid-cols-[repeat(3,135px)_1fr] gap-8 slg:grid-cols-1">
          <div>
